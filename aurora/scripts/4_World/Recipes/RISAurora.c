class Recipe_RISAurora extends RecipeBase{
    	override void Init()
	{
		m_Name = "Mount to RIS adapter";
		...
		//ingredient 2
		InsertIngredient(1,"RISCameraAdapter");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("RISAurora");//add results here
