class Dismantle_HMDAurora2 extends RecipeBase{
    	override void Init()
	{
		m_Name = "Remove One Aurora";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"HMDAurora2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HMDAurora");//add results here
