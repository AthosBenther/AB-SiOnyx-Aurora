class Dismantle_RISAurora extends RecipeBase{
    	override void Init()
	{
		m_Name = "Remove RIS Adapter";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"RISAurora");//you can insert multiple ingredients this way
		...
		AddResult("RISCameraAdapter");//add results here
