class Recipe_HMDAurora2 extends RecipeBase{
    	override void Init()
	{
		m_Name = "Mount to Rhino mount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"HMDAurora");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HMDAurora2");//add results here
